...
async function postToBlogger(blogData) {
  ...
  <style>
    ...
    .centered-top, .centered-top-container {
      display: none !important; height: 0 !important; visibility: hidden !important; opacity: 0 !important; position: absolute !important; top: -2000px !important; 
    }
    ...
    .brand-box::after {
      ...
      border: 1px solid #b08a5c; pointer-events: none;
    }
    .brand-box span {
    ...
    /* 3. CONTENT */
    .mia-main {
      max-width: 760px; margin: -80px auto 0 !important; 
      background: #ffffff; padding: 125px 22px 100px !important; 
      position: relative; z-index: 10;
    }
    .mia-meta {
      text-align: center; font-size: 0.76rem; letter-spacing: 3px;
      text-transform: uppercase; color: #b08a5c; margin: 0 0 10px 0 !important; font-weight: 600;
    }
    .mia-title {
      font-family: 'Playfair Display', serif; font-size: clamp(2.3rem, 6vw, 3.4rem);
      text-align: center; line-height: 1.2; margin: 0 0 40px; color: #000;
    }
    .mia-image-wrap { width: 100%; margin-bottom: 50px; }
    .mia-image-wrap img {
      width: 100%; height: auto !important; border-radius: 15px; display: block; margin: 0 auto;
    }
    ...
    @media (max-width: 768px) {
      ...
      .mia-main { padding-top: 115px !important; margin-top: -90px !important; }
    }
  </style>
